...
public class SendNotifyMessage {
     ...
     */
    public static void sendNotification() throws HuaweiMesssagingException {
        ...
        Message message = Message.builder().setNotification(notification)
                ...
                .addToken("ALL0u2XCIYnGkETGbMRKoAD_o6e1ZK58uVivgwR6vhZCM4V_DafkzzZ8UvLx8h_zW4eO6F9Ug5aMvDtyNvRgEwIoYYrS5WdodjpXkmwfCWltPVwr-AtAizlomlVxfB1h6Q")
                .build();
